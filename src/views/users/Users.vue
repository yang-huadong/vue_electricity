  ...
  <div>
    ...
    <el-card class="box-card">
      <el-row :gutter="20">
        ...
        <el-col :span="4">
          <el-button type="primary" icon="el-icon-search" @click="newlyUser">添加用户</el-button>
        </el-col>
      </el-row>
      ...
      <el-table stripe :data="userList" border>
        ...
        <!-- remarks：备注 -->
        <el-table-column prop="mg_state" label="备注"></el-table-column>
      ...
      <!-- 分页 -->
      <el-pagination :pager-count="5" @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="queryInfo.pagenum" :page-sizes="[1, 2, 3, 5]" :page-size="queryInfo.pagesize" layout="total, sizes, prev, pager, next, jumper" :total="total">
      </el-pagination>

      <!-- 添加用户提交弹框 -->
      <el-dialog :title=dialogName :visible.sync="addDialogVisible" width="50%" @closed="addDialogClosed">
        <!-- 表单 -->
        <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="90px">
          ...
          <!-- 分配角色对话框 -->
          <!-- <el-dialog title="分配角色" @close="addDialogClosed" :visible.sync="addDialogVisible" width="50%"> -->
          <!-- <p>当前用户：{{userInfo.username}}</p>
          <p>当前角色：{{userInfo.role_name}}</p> -->
          <!-- 分配角色 -->
          <el-form-item label="分配角色" prop="cast">
      ...
      <!-- 修改编辑用户提交弹框 -->
      <el-dialog :title=dialogName :visible.sync="editDialogVisible" width="50%" @closed="editDialogClosed">
        <!-- 表单 -->
